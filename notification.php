...
<body>
    ...
    <nav id="sidebar">
        ...
        <div id="menu">
            <h4>Notification</h4>
            <ul>
                <li><a href="notification.php" class="active">All</a></li>
                <li><a href="reminders.php" class="notActive">Reminders</a></li> <!--HTML BELUM BUAT-->
            </ul>
        </div>
    ...
    <div id="banner">
        <h4>Notification</h4>
        <p>Stay updated with the latest event and messages
        </p>
    </div>
...
?>
                <div class="notificationCard">
                    ...
                    if ($row['notification_type'] == "event") {

                        $icon = "campaign";
                        $iconClass = "eventIcon";
                    } elseif ($row['notification_type'] == "reply") {
                    ...
                    <span class="material-symbols-outlined notificationIcon <?= $iconClass; ?>">
