                    ...
                    <form method="post" action="updateEventProcess.php" enctype="multipart/form-data">
                        ...
                        <select id="category" disabled>
                            ...
                            <optgroup label="Faculty">
                                ...
                                <option value="SCHOOL OF INTERNATIONAL STUDIES AND GLOBAL LANGUAGES"
                                    <?php if ($category == "SCHOOL OF INTERNATIONAL STUDIES AND GLOBAL LANGUAGES") echo "selected"; ?>>
                                    SCHOOL OF INTERNATIONAL STUDIES AND GLOBAL LANGUAGES
                                </option>
                                <option value="SPS" <?php if ($category == "SPS") echo "selected"; ?>>SPS</option>
                                <option value="IPTK" <?php if ($category == "IPTK") echo "selected"; ?>>IPTK</option>
                            </optgroup>

                            <optgroup label="Residential Colleges">
                                <option value="KOLEJ KEDIAMAN LESTARI" <?php if ($category == "KOLEJ KEDIAMAN LESTARI") echo "selected"; ?>>KOLEJ KEDIAMAN LESTARI</option>
                                <option value="KOLEJ KEDIAMAN AL-JAZARI" <?php if ($category == "KOLEJ KEDIAMAN AL-JAZARI") echo "selected"; ?>>KOLEJ KEDIAMAN AL-JAZARI</option>
                                <option value="KOLEJ KEDIAMAN SATRIA TUAH" <?php if ($category == "KOLEJ KEDIAMAN SATRIA TUAH") echo "selected"; ?>>KOLEJ KEDIAMAN SATRIA TUAH</option>
                                <option value="KOLEJ KEDIAMAN SATRIA JEBAT" <?php if ($category == "KOLEJ KEDIAMAN SATRIA JEBAT") echo "selected"; ?>>KOLEJ KEDIAMAN SATRIA JEBAT</option>
                                <option value="KOLEJ KEDIAMAN SATRIA KASTURI" <?php if ($category == "KOLEJ KEDIAMAN SATRIA KASTURI") echo "selected"; ?>>KOLEJ KEDIAMAN SATRIA KASTURI</option>
                                <option value="KOLEJ KEDIAMAN SATRIA LEKIR" <?php if ($category == "KOLEJ KEDIAMAN SATRIA LEKIR") echo "selected"; ?>>KOLEJ KEDIAMAN SATRIA LEKIR</option>
                                <option value="KOLEJ KEDIAMAN SATRIA LEKIU" <?php if ($category == "KOLEJ KEDIAMAN SATRIA LEKIU") echo "selected"; ?>>KOLEJ KEDIAMAN SATRIA LEKIU</option>
                            </optgroup>
